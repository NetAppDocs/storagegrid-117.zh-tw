...
* 若要在SG6060儲存應用裝置中新增一或兩個擴充櫃、請前往 link:../sg6000/adding-expansion-shelf-to-deployed-sg6060.html["新增擴充櫃至已部署的SG6060"]。
* 若為軟體型節點、請依照的指示進行link:adding-storage-volumes-to-storage-nodes.html["將儲存磁碟區新增至儲存節點"]。
